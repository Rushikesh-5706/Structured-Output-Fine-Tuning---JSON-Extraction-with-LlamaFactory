...
Model: Llama-3.2-3B-Instruct + LoRA adapter (trained on curated_train.jsonl)
Inference tool: LlamaFactory inference tab
Temperature: 0.0
Prompt: Same extraction prompt as used for baseline (see eval/baseline_responses.md)
